return {
  ...
  keys = {
    ...
    { "<leader>gr",  "<cmd>Telescope lsp_references<cr>",      desc = "gives out the references in a telescope list" },
    { "<leader>gi",  "<cmd>Telescope lsp_implementations<cr>", desc = "gives out the implementations in a telescope list" },
